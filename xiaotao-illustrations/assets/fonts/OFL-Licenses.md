# 内置字体许可证 / Bundled Font Licenses

本目录内置的字体均遵循 SIL Open Font License 1.1，可自由使用、嵌入和随软件分发。

| 字体文件 | 字体名 | 版权 |
|---|---|---|
| `LXGWWenKai-Regular.ttf` | 霞鹜文楷 LXGW WenKai | Copyright 2021-2026 LXGW |
| `JetBrainsMono-Regular.ttf` | JetBrains Mono | Copyright 2020 The JetBrains Mono Project Authors |
